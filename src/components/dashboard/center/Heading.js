  ...
  return (
    <div className="heading">
                    ...
                    <div>
                        ...
                        <img src="assets/arrow-leftlight-arrow.png" alt="" className='prev' onClick={handleMentorsList}/>
                        <img src="assets/arrow-rightdark-arrow.png" alt="" className='next'onClick={handleMentorsList}/>
                    </div>
                </div>
  )
}
